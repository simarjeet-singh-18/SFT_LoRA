...
def apply_single_filter_and_lora(
    ...
    # 3. Freeze base parameters and enable gradients for Filter, LoRA, and Classifier Head
    for name, param in model.named_parameters():
        if "lora_" in name or f"blocks.{pruned_block_idx}" in name or "head" in name:
